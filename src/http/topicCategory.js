...
// data json         /mall/cms-topic-category/one/{id}
...
const topicCategoryPage=(data)=>{
    return instance.request({
     url:'mall/cms-topic-category-category/page',
     method:'post',
     data
    })
 }
 ...
 const topicCategoryOne=(data)=>{
    return instance.request({
     url:'/mall/cms-topic-category-category/one/{id}',
     method:'post', 
     data
    })
 }
...
//      return instance.request({
//          url:'mall/cms-topic-category-category/del/'+params.id,
//          method:"get",
//          // params
//      })
//  }
...
//      return instance.request({
//          url:' /mall/cms-topic-category-category/add',
//          method:'post',
//          data
//      })
//  }
...
//      return instance.request({
//          url:'mall/cms-topic-category-category/edit',
//          method:'post',
//          data
//      })
//  }
